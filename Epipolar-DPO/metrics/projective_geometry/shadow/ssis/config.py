...
_C.MODEL.FCOS.OFFSET = False
_C.MODEL.FCOS.CLASS_AWARE = False
...
_C.MODEL.CONDINST.MASK_HEAD.DEFORM_MASKIOU = False
_C.MODEL.CONDINST.MASK_HEAD.BOUNDARY_LOSS = False
