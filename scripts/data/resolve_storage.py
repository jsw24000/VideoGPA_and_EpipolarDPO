...
def build_storage_config(layout) -> dict:
    return {
        ...
        "dl3dv_raw_960p": str(layout.dl3dv_raw_960p),
        "first_frames": str(layout.first_frames),
        "download_cache": str(layout.download_cache),
        "staging": str(layout.staging),
        "canonical_paths": "relative_to_asset_root",
    }
...
def main() -> int:
    ...
    try:
        ...
        config_path = layout.project_data / "configs" / "storage.local.yaml"
