# WAN2.2 5B I2V Formal Candidate Generation

This directory mirrors the WAN2.2 5B T2V formal candidate-generation stage, but uses `train_i2v.json` samples with a first-frame image and camera-motion prompt.
